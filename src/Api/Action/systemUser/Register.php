<?php
    ...
    class Register {
        ...
        public function __invoke(Request $request): systemUser {
            ...
            return $this->service->create($user, $password, $email, $selfie, $tag, $fullName, $address, $phone, $area, $idOffice, $idSystemUserStatus, $idSystemRole, $idEmployee, $tries, $position, $skype);
        }
    }