<?php
    ...
    use App\Model\systemTemplateFrontPageModel;
    ...
    class Table {
        ...
        private systemTemplateFrontPageModel $model;
    
        public function __construct(Datatable $datatable, systemTemplateFrontPageModel $model) {
